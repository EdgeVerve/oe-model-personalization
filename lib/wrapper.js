...
module.exports = function (app) {
  ...
  function callRealFn(fn, self, args, optionsIndex) {
    ...
    if (!self.definition.settings.mixins || !self.definition.settings.mixins.ModelPersonalizationMixin || (self.definition.settings.overridingMixins && self.settings.overridingMixins.ModelPersonalizationMixin))
