...
var utils = require('oe-multi-tenancy/lib/utils.js');
...
function _getFromModelCache(autoscopeFields, modelName, options) {
  ...
  return currentModel.model ? currentModel.model : null;
}
...
// module.exports.isDefaultScope = _isDefaultContext;
module.exports.checkModelWithPlural = _checkModelWithPlural;
