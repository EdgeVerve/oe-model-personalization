...
```sh
$ git clone https://github.com/EdgeVerve/oe-model-personalization.git
...
```javascript
"oe-model-personalization": "git+https://github.com/EdgeVerve/oe-model-personalization.git#2.0.0"
```
